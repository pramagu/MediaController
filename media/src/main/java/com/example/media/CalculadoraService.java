...
public class CalculadoraService {
    ...
    public int suma(OkHttpClient client, int sumaTemperaturaMedia, TemperaturaResponse temperaturaResponse, int temperaturaBucle)
        ...
        Request request = new Request.Builder()
                .url("https://calculadorarest.herokuapp.com/operaciones/suma?ope1=" + sumaTemperaturaMedia + "&ope2="
                        + temperaturaBucle)
                .get()
    ...
    throws NumberFormatException, IOException {
        ...
        Request request = new Request.Builder()
                .url("https://calculadorarest.herokuapp.com/operaciones/divide?ope1=" + sumaTemperaturaMedia + "&ope2=" + tamano)
                .get()
                .addHeader("cache-control", "no-cache")
                .build();
